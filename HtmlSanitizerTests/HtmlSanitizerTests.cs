...
";
        ...
        [TestMethod]
        public void PersistStyleOfDivTest()
        {
            var html = "<div style=\"color:#0000FF\"></div>";
            string result = HtmlSanitizer.SanitizeHtml(html);
            //style tag will not be removed as it has valid values.
            Assert.IsFalse(result.Contains(html));
        }
    }
